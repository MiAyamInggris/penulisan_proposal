...
export async function GET() {
  ...
  const infoRows = [
    { Keterangan: "=== PETUNJUK — IMPORT PLOTTING SIDANG (METODE 2 — SEMI-OTOMATIS) ===" },
    { Keterangan: "" },
    ...
    { Keterangan: "  Buka tab 'Belum Penguji' untuk menugaskan Penguji 1 dan 2 secara manual." },
    { Keterangan: "" },
    { Keterangan: "CATATAN:" },
    { Keterangan: "  - NIM yang sudah ada akan diperbarui (pembimbing diperbarui, penguji tidak diubah)" },
  ...
  return new NextResponse(new Uint8Array(raw), {
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="template-plotting-sidang-semi.xlsx"',
    },
  });
}
