...
export default async function DosenKelasNilaiDetailPage({
  params,
}: {
  ...
  if (targetClass.dosenKelasId !== session.user.id) redirect("/dosen-kelas/nilai");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          ...
          <span className="font-medium text-gray-700">{targetClass.program.code}</span>
        </p>
      </div>
      <Card>
        <CardHeader>
